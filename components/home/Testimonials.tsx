...
const fallbackTestimonials = [
    {
        id: 1,
        name: 'คุณนนท์',
        location: 'เจ้าของรีสอร์ท เกาะช้าง',
        rating: 5,
        text: 'บริการดี มาไว สุภาพ ไว้ใจได้ครับ เรียกใช้บริการประจำสำหรับรีสอร์ทที่เกาะช้าง หมดปัญหาเรื่องปลวกไปเลย',
        service: 'กำจัดปลวกระบบเหยื่อ',
    },
    {
        id: 2,
        name: 'คุณวิภา',
        location: 'เจ้าของร้านอาหาร จันทบุรี',
        rating: 5,
        text: 'ประทับใจความเร็วในการเข้าหน้างานมากค่ะ โทรปุ๊บมาปั๊บ งานเรียบร้อย สะอาด ไม่ทิ้งคราบ',
        service: 'กำจัดแมลงสาบและหนู',
    },
    {
        id: 3,
        name: 'คุณประเสริฐ',
        location: 'โรงงานผลไม้แปรรูป ตราด',
        rating: 5,
        text: 'ทีมงานมีความเป็นมืออาชีพสูง มีใบรับรองถูกต้อง ตรวจสอบได้ ยินดีที่ได้ร่วมงานครับ',
        service: 'วางระบบป้องกันปลวก',
    },
];

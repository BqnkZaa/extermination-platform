...
const areas = [
    ...
    },
    {
        name: 'ตราด',
        nameEn: 'Trat',
        districts: ['เมืองตราด', 'คลองใหญ่', 'เขาสมิง', 'บ่อไร่', 'แหลมงอบ', 'เกาะช้าง'],
    },
    {
        name: 'ระยอง',
        nameEn: 'Rayong',
            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            เราให้บริการครอบคลุมพื้นที่ 3 จังหวัดภาคตะวันออก พร้อมทีมงานประจำพื้นที่
                            สามารถเข้าถึงได้รวดเร็วภายใน 24 ชั่วโมง
                        </motion.p>
